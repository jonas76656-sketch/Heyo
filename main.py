...
def start(message):
	if not str(message.chat.id) == '1884542666':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @jonas_839")
		return
